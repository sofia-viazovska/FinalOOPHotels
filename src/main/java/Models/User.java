...
public class User implements Serializable {
    ...
    public User(String id, String username, String password, String fullName, String email, String phoneNumber) {
        // Initialize the user with basic information
        this.id = id;
    ...
    public User(String id, String username, String password, String fullName, String email, String phoneNumber, boolean isAdmin) {
        // Initialize the user with admin status specified
        this.id = id;
        this.username = username;
        this.password = password;
        this.fullName = fullName;
        this.email = email;
        this.phoneNumber = phoneNumber;
        this.isAdmin = isAdmin; // Set admin status based on the parameter
        this.bookings = new ArrayList<>(); // Initialize an empty bookings list
    }
    ...
    public void removeBooking(Booking booking) {
        // Remove booking from the user's list
